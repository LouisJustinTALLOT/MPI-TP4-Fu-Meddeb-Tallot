...
\input{sections/introduction_scientifique}

\section*{Objectifs}
\input{sections/objectifs}

\section*{Démarche mise en œuvre}
\input{sections/demarche}

\section*{Description des outils utilisés}
\input{sections/description_outils}

\section*{Présentation des résultats obtenus}
\input{sections/resultats_obtenus}

\section*{Conclusion scientifique}
\input{sections/conclusion_scientifique}
